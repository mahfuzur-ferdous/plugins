...
public class PluginViewLocationExpander : IViewLocationExpander
{
    ...
    public IEnumerable<string> ExpandViewLocations(ViewLocationExpanderContext context, IEnumerable<string> viewLocations)
    {
        if (context.AreaName == "Admin")
        {
            ...
            {
                $"/Plugins/Payments.PurchaseOrder/Areas/Admin/Views/{{0}}.cshtml",
                $"/Plugins/Payments.PurchaseOrder/Areas/Admin/Views/{{1}}/{{0}}.cshtml"
        ...
        else
        {
            viewLocations = new string[]
            {
                $"/Plugins/Nop.Plugin.Payments.PurchaseOrder/Areas/Admin/Views/{{0}}.cshtml",
                $"/Plugins/Nop.Plugin.Payments.PurchaseOrder/Areas/Admin/Views/{{1}}/{{0}}.cshtml"
            }.Concat(viewLocations);
        }
